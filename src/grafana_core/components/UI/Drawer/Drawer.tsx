...
const drawerSizes = {
  sm: { width: '15vw', minWidth: 384 },
  md: { width: '30vw', minWidth: 568 },
...
export function Drawer({
    ...
    const sizeStyles = useStyles2(getSizeStyles, size, drawerWidth);
...
function getSizeStyles(theme: GrafanaTheme2, size: 'sm' | 'md' | 'lg' = 'sm', overrideWidth: number | string | undefined) {

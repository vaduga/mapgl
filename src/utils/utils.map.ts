...
import { denormalizeZoom, fitCartesianBounds, getLayerFitBounds, getLogicFitBounds } from '@mapgl/panel-core/utils';
          ...
          try {
            ...
            if (panel.isLogic) {
              ({
                ...
                latitude: lat,
                zoom,
              } = fitCartesianBounds([minLng, minLat, maxLng, maxLat], width, height, {

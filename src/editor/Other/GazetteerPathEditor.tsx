...
import {Alert, Select, stylesFactory, useStyles2, useTheme2} from '@grafana/ui';
import {COUNTRIES_GAZETTEER_PATH, Gazetteer, getGazetteer} from '../../grafana_core/app/features/geo/gazetteer/gazetteer';
import { css } from '@emotion/css';

const paths: any[] = [
  // {
  //   label: 'Cities',
  //   description: 'Lookup cities by name or three letter code',
  //   value: CITIES_GAZETTEER_PATH,
  // },
  {
    label: 'Countries',

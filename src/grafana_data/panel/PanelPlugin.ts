...
import {
  ...
  FieldConfigSource,
  GrafanaPlugin, PanelEditorProps, PanelMigrationHandler, PanelOptionsEditorBuilder, PanelPluginDataSupport,
  PanelPluginMeta, PanelProps, PanelTypeChangedHandler, SetFieldConfigOptionsArgs, StandardEditorContext,

...
export function createPathLayer({
  StyleEditor,
}: Pick<DataLayerEditorAdapters, 'StyleEditor'>): ExtendMapLayerRegistryItem<PathConfig> {
  return {
    id: PATH_LAYER_ID,
    name: 'Path layer',
   ...
   * @param options
   */
    create: async (panel: any, options: ExtendMapLayerOptions<PathConfig>, theme: GrafanaTheme2) => {

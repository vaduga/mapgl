import { PanelData, DataFrameView, GrafanaTheme2, PanelProps } from '@grafana/data';
...
export function createPolygonsLayer({
  StyleEditor,
}: Pick<DataLayerEditorAdapters, 'StyleEditor'>): ExtendMapLayerRegistryItem<PolygonsConfig> {
  return {
   ...
   * @param options
   */
    create: async (panel: any, options: ExtendMapLayerOptions<PolygonsConfig>, theme: GrafanaTheme2) => {

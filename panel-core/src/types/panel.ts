import { FeatSource, Graph } from '@mapgl/panel-core/graph';
import type { GraphFrameInstanceState } from '@mapgl/panel-core/graph/frame';
...
export interface MapInstanceState {
  ...
  graphFrame?: GraphFrameInstanceState;
}
